...
public class CreateAndUpdateCommand implements INuxeoCommand {
    
    private final Configuration configuration;
    String suffix;
    
    public CreateAndUpdateCommand(Configuration configuration, String suffix) {
        super();
        ...
        try {
            ...
            if (object instanceof FileBlob)
            {
                ...
                try {
                    ...
                    commandNotification = new CommandNotification(true, "Création et mise à jour réussie sur : "+createdDoc.getInputRef());
                } catch (Exception e) {
